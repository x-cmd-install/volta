...
[![x-cmd/install — volta Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/volta.svg?lang=zh)](https://x-cmd.com/install/volta)
...
合计: **24,825** 行代码（覆盖前 5 种语言、共 **186** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 23,068 | 729 | 3,345 | 140 |
| Sh | 938 | 161 | 212 | 8 |
| Json | 392 | 0 | 0 | 26 |
| Autoconf | 190 | 27 | 40 | 1 |
| Toml | 178 | 12 | 21 | 11 |
...
- **最新版本**: `v2.0.2` (2024-12-05)
- **最近提交**: 2025-11-15
- **Release 含资产**: 8 个

## 流行度

- **Star**: 13,069 · **Fork**: 332 · **开放 issue**: 973 · **贡献者**: 54

## 累计统计

- **发布数**: 62 · **已合并 PR**: 886 · **开放 PR**: 26 · **已关闭 issue**: 655 · **开放 issue**: 318 · **提交数**: 3168
...
| last180d | 2026-03-30 | 0 | 0 | 1 | 0 | 8 | 0 |
| 360d | 2025-10-01 | 0 | 1 | 7 | 3 | 19 | 3 |
| last720d | 2024-10-06 | 1 | 58 | 21 | 18 | 62 | 118 |
...
volta 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `volta` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/volta.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T05:33:04Z._
